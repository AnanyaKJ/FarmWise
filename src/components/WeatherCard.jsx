...
//from OpenWeatherMap API call below
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-8 mb-6 sm:mb-8">
          <div className="text-center md:text-left">
            <h2 className="text-2xl sm:text-4xl font-bold text-purple-200 mb-2 sm:mb-3">
              {weather.name}
            </h2>
            <p className="text-4xl sm:text-6xl font-bold bg-gradient-to-r from-purple-400 to-blue-500 bg-clip-text text-transparent">
              {Math.round(weather.main.temp)}°C
            </p>
            <p className="text-base sm:text-lg text-violet-300 mt-2 sm:mt-3 capitalize">
          ...
          >
            <WeatherIcon 
              ...
              size="text-6xl sm:text-8xl text-purple-300" // Added text-white
            />
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-6 sm:mb-8">
          {[
            { icon: <FaTemperatureHigh className="text-violet-300" />, label: "Feels Like", value: `${Math.round(weather.main.feels_like)}°C` },
            { icon: <FaTint className="text-violet-300" />, label: "Humidity", value: `${weather.main.humidity}%` },
            { icon: <FaWind className="text-violet-300" />, label: "Wind", value: `${weather.wind.speed} m/s` }
          ].map((item, index) => (
            <motion.div
              key={index}
            ...
            >
              ...
              <p className="text-xs sm:text-sm text-white mb-1">{item.label}</p>
        ...
        {/* Forecast Section */}
        <div>
          <h3 className="text-lg sm:text-xl font-bold text-violet-300 mb-4 sm:mb-6">
            Upcoming Weather
          </h3>
                ...
                <div className="flex items-center justify-between gap-2 sm:gap-4">
                  <div className="flex items-center gap-2 sm:gap-4">
                    <WeatherIcon 
                      ...
                      size="text-2xl sm:text-3xl text-purple-300" // Added text-white
                    />
                    <div>
                  ...
                  <p className="text-[10px] sm:text-xs text-white/80 capitalize">
