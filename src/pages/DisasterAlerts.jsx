...
const DisasterAlerts = () => {
  ...
  return (
    <div className="min-h-screen relative pt-10"
      style={{
        // EDIT HERE: Adjust the blur value (currently 8px) to increase/decrease blur effect
        backdropFilter: 'blur(50px)',
        WebkitBackdropFilter: 'blur(8px)',
        backgroundImage: "url('https://www.gamepur.com/wp-content/uploads/2022/01/04113830/The_Elder_Scrolls_Online_stormy_sea.jpg')",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-blue-200 via-purple-200 to-violet-700 bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 gap-8 max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="backdrop-blur-xl bg-white/5 rounded-2xl p-8 border border-white/10 w-full transform scale-120"
          >
