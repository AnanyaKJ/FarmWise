...
//API request to fetch precipt data
  ...
  return (
    <motion.div 
      ...
      style={{
        ...
        backgroundImage: "url('https://wallpaperaccess.com/full/777994.jpg')", 
    ...
    >
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 pb-12">
          ...
          >
            <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-blue-300 via-white to-purple-500 bg-clip-text text-transparent">
              Farm Analytics
            </h1>
            <p className="text-xl text-white/90">
              Monitor weather and soil conditions for better decision making
            </p>
          </motion.div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="bg-gradient-to-r from-blue-400 to-violet-500 text-white rounded-lg p-3 h-[46px] mt-auto"
              >
                Analyze Data
              </motion.button>
            </form>
