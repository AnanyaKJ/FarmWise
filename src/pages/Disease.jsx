...
const Disease = () => {
  ...
  return (
    <motion.div
      ...
      style={{
        backdropFilter: 'blur(60px)', // Added strong blur
        WebkitBackdropFilter: 'blur(60px)', // For Safari support
        backgroundColor: 'rgba(0, 0, 0, 0.6)', // Added slight overlay
        backgroundImage: "url('https://img.freepik.com/premium-photo/blue-green-coronavirus-cell-with-blue-background_899894-54577.jpg')",
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        backgroundAttachment: 'fixed',
        backgroundBlendMode: 'overlay' // Added blend mode for better blur effect
      }}
    >
      <Navbar customGradient="bg-gradient-to-r from-lime-500 via-green-700 to-teal-800" />
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-lime-200 via-lime-300 to-teal-400 bg-clip-text text-transparent">
          ...
          <div className="backdrop-blur-xl bg-white/5 rounded-2xl p-6 border border-white/10">
            {showCamera ? (
              ...
              <div className="space-y-6">
                {image ? (
                  <div className="relative">
                    <div className="mt-4 w-[50%] mx-auto"> {/* Reduced from w-full or original width */}
                      <img
                        src={image}
                        alt="Captured"
