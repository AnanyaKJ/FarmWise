...
const CropsData = () => {
  ...
  return (
    ...
    style={{
      backgroundImage: "url('https://png.pngtree.com/background/20210716/original/pngtree-crop-green-rice-light-effect-wallpaper-picture-image_1334589.jpg')",
  ...
  >
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-green-800 via-lime-800 to-lime-900 bg-clip-text text-transparent">
            Crop Database
          </h1>
          <p className="text-xl text-lime-800">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-lime-600 border border-white/10 rounded-lg 
                       text-white placeholder-white/90 focus:outline-none focus:border-blue-500"
            />
          </div>
  ...
  className="pl-12 pr-8 py-3 bg-lime-700 border border-white/10 rounded-lg 
             text-white appearance-none focus:outline-none focus:border-blue-500
             [&>option]:bg-lime-800 [&>option]:text-white"
>
  <option value="All" className="text-white bg-lime-800">All Water Requirements</option>
        ...
        >
          {filteredCrops.map((crop, index) => (
            <motion.div
              ...
              className="backdrop-blur-xl bg-lime-200/60 rounded-xl p-6 cursor-pointer shadow-lg hover:bg-lime-200/60 transition-all duration-300"
            >
