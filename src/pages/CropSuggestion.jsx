  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <div className="backdrop-blur-xl bg-lime-300/10 rounded-2xl p-6 border border-white/10">
            <div className="flex items-center gap-3 mb-4">
              <FaMapMarkerAlt className="text-2xl text-lime-800" />
              <h2 className="text-xl font-semibold text-lime-800">Location Search</h2>
            </div>
            ...
            <form onSubmit={(e) => {
              ...
              <input
                ...
                focus:ring-2 focus:ring-green-500 focus:border-lime-500"
              />
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="bg-gradient-to-r from-green-500 to-lime-800 text-white rounded-lg px-6 py-2"
              >
                <FaSearch />
              </motion.button>
            </form>
          ...
          <>
            ...
            >
              ...
              {recommendations.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {recommendations.map(([cropName, data]) => (
                    <motion.div
                      key={cropName}
                      whileHover={{ scale: 1.02 }}
                      className="backdrop-blur-xl bg-lime-300/10 rounded-2xl p-6 border border-white/10"
                    >
                      <div className="flex items-center gap-3 mb-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-3">
                          <p className="text-white">{data.tips}</p>
                        </div>
                      </div>
                    </motion.div>
                  ))}
                ...
                <div className="text-center text-white/60 py-8 bg-lime-300/10 backdrop-blur-xl rounded-2xl border border-white/10">
