  ...
  return (
    ...
    >
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          ...
          >
            ...
            <p className="text-xl text-white/80 leading-relaxed">
              FarmWise is committed to transforming agriculture through innovative technology solutions, 
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            FarmWise is dedicated to advancing agriculture through innovation,
             offering farmers state-of-the-art tools for precision farming.
              With our user-friendly platform, farmers gain access to real-time data analytics, 
              AI-powered insights, and automated solutions tailored to their specific needs.
               These resources help to minimize resource waste, improve soil health, and optimize crop production. 
               By leveraging these technologies, farmers can enhance both their profitability and 
               environmental sustainability, ensuring a future where agriculture thrives without
                compromising the planet's health. Our commitment to continuous innovation makes
                 FarmWise the go-to platform for modern, efficient, and sustainable farming.
            </p>
      ...
      >
        ...
        <button 
          onClick={() => navigate('/')}
          className="px-8 py-3 bg-gradient-to-r from-green-400 to-blue-500 rounded-lg text-white font-semibold hover:opacity-90 transition-opacity"
        >
          Get Started
        </button>
      </motion.div>
